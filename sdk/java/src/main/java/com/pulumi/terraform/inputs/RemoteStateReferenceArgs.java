...
import com.pulumi.terraform.inputs.WorkspacesArgs;
...
public final class RemoteStateReferenceArgs extends com.pulumi.resources.InvokeArgs {

    public static final RemoteStateReferenceArgs Empty = new RemoteStateReferenceArgs();
    ...
    private RemoteStateReferenceArgs() {}

    private RemoteStateReferenceArgs(RemoteStateReferenceArgs $) {
    ...
    public static Builder builder(RemoteStateReferenceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteStateReferenceArgs();
        }

        public Builder(RemoteStateReferenceArgs defaults) {
            $ = new RemoteStateReferenceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteStateReferenceArgs build() {
            $.hostname = Codegen.stringProp("hostname").output().arg($.hostname).def("app.terraform.io").getNullable();
            if ($.organization == null) {
                throw new MissingRequiredPropertyException("RemoteStateReferenceArgs", "organization");
            }
            if ($.workspaces == null) {
                throw new MissingRequiredPropertyException("RemoteStateReferenceArgs", "workspaces");
            }
            return $;
        }
    }
