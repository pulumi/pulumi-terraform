...
import com.pulumi.terraform.ProviderArgs;
import com.pulumi.terraform.Utilities;
import javax.annotation.Nullable;

@ResourceType(type="pulumi:providers:terraform")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(java.lang.String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("terraform", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
