...
namespace Pulumi.Terraform
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Terraform.version.txt");
    ...
    internal sealed class TerraformResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TerraformResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
